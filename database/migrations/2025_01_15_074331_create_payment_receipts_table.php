...
return new class extends Migration {
    ...
    public function up(): void
    {
        Schema::create('payment_receipts', function (Blueprint $table) {
            ...
            $table->integer('receipt_from_number')->nullable();
            $table->integer('receipt_to_number')->nullable();
            $table->integer('total_cumulative_quantity')->default(0);
            $table->string('received_by')->nullable();

            // Distribution Section (in the same row)
            $table->string('given_to')->nullable();
            $table->string('pin_number')->nullable();
            $table->integer('given_from_number')->nullable();
            $table->integer('given_to_number')->nullable();
