        ...
        >
            ...
            >
                <a
                    ...
                    target="_self"
                    class="group inline-flex items-center gap-2 px-3.5 py-2 rounded-xl bg-slate-900 text-white hover:bg-amber-600 dark:bg-amber-600 dark:hover:bg-amber-500 font-bold text-xs shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105"
