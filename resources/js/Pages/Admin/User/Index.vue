    ...
    <AdminLayout>
        <div class="container mx-auto px-4 py-8">
            <div class="bg-white dark:bg-gray-800 shadow-lg rounded-lg overflow-hidden">
                ...
                <div class="p-4 sm:p-6 space-y-4">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4">
                        ...
                        <div class="relative flex-grow">
                            <input v-model="filters.search" type="text" placeholder="Search users..." class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500
                        ...
                        <!-- Per Page -->
                        <select v-model="filters.per_page" @change="getUsers" class="w-full sm:w-32 px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500
                                   dark:bg-gray-700 dark:border-gray-600 dark:text-gray-200">
                            ...
                            <tr>
                                ...
                                <th @click="sort('name')"
                                    ...
                                    <div class="flex items-center">
                                        Name
                                        <SortIcon :field="'name'" :current-sort="filters.sort"
                                ...
                                <th @click="sort('email')"
                                    ...
                                    <div class="flex items-center">
                                        Email
                                        <SortIcon :field="'email'" :current-sort="filters.sort"
                                            :direction="filters.direction" />
                                    </div>
                                </th>
                                <th @click="sort('branch_name')"
                                    ...
                                    <div class="flex items-center">
                                        Branch
                                        <SortIcon :field="'branch_name'" :current-sort="filters.sort"
                                            :direction="filters.direction" />
                                    </div>
                                </th>
                                <th
                                ...
                                <td class="p-4 whitespace-nowrap">
                                    <div class="flex flex-col">
                                        ...
                                        <template class="md:hidden" v-if="getBranches(user).length > 0">
                                            <span  class="text-xs text-gray-500 lg:hidden mt-1 md:hidden">
                                        {{ displayedBranchNames(user) }}
                                    </span>
                                        <button v-if="getBranches(user).length > 1" @click="showAllBranches(user)"
                                            class="ml-1 text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300 md:hidden">
                                            +{{ getBranches(user).length - 1 }} more
                                        </button>
                                    </template>
                ...
                <!-- Pagination -->
                <Pagination :data="users" :item-name="'users'" :extra-params="filters" />
            </div>
        </div>

        <!-- Delete Confirmation Dialog -->
        <ConfirmationDialog :show="showDeleteDialog" title="Delete User"
