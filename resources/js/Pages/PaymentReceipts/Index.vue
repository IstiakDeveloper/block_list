                ...
                <div v-if="isSuperAdmin" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <div v-for="summary in branchSummaries" :key="summary.branch_id"
                        ...
                        <div class="space-y-4">
                            ...
                            <!-- All Time Stats -->
                            <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                                <h4 class="text-sm font-medium text-gray-600 dark:text-gray-400 mb-3">All Time</h4>
                                <div class="grid grid-cols-2 gap-4">
                                    <div>
                ...
                <div v-else class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <div class="grid gap-6">
                            <!-- Current Period -->
                            <div>
                                <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100 mb-4">Current Period
                                </h3>
                            ...
                            <!-- All Time Stats -->
                            <div>
                                <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100 mb-4">All Time</h3>
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                                        <div class="text-sm text-gray-500 dark:text-gray-400">Total Received</div>
                                        <div class="text-2xl font-semibold text-gray-900 dark:text-gray-100">
                                ...
                                <thead>
                                    <tr>
                                        <th scope="col" colspan="1"
                                            class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider bg-gray-50 dark:bg-gray-700">
                                            Date
                                        </th>
                                        <th scope="col" colspan="5"
                                            class="px-6 py-3 text-center text-xs font-medium text-green-600 dark:text-green-400 uppercase tracking-wider bg-green-50 dark:bg-green-900/30">
                                            Receive Section
                                        </th>
                                        <th scope="col" colspan="6"
                                            class="px-6 py-3 text-center text-xs font-medium text-blue-600 dark:text-blue-400 uppercase tracking-wider bg-blue-50 dark:bg-blue-900/30">
                                ...
                                <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                    <tr v-for="receipt in receipts.data" :key="receipt.id"
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm"
                                            :class="[receipt.receive_quantity ? 'text-green-600 dark:text-green-400 font-medium' : 'text-gray-400 dark:text-gray-500']">
                                        ...
                                        <!-- Distribution Data -->
                                        <td class="px-6 py-4 whitespace-nowrap text-sm"
                                            :class="[receipt.given_to ? 'text-blue-600 dark:text-blue-400 font-medium' : 'text-gray-400 dark:text-gray-500']">
                                            {{ receipt.given_to || '-' }}
                                        </td>
                                        <td
                                            class="px-6 py-4 whitespace-nowrap text-sm text-gray-600 dark:text-gray-400">
