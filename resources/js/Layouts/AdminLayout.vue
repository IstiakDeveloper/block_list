    ...
    <div class="flex h-screen overflow-hidden bg-gray-100 dark:bg-gray-700">
      ...
      >
        ...
        <nav class="mt-5">
            ...
            <div class="mt-5">
                <Link href="/profile" class="block flex items-center gap-2 px-4 py-2 text-gray-700 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-900">
                <svg class="w-5 h-5 text-gray-700 dark:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <Link :href="route('logout')" method="post" as="button" class="block flex items-center gap-2 px-4 py-2 text-gray-700 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-900">
                <svg class="w-5 h-5 text-gray-700 dark:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
