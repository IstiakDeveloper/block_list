<template>
    <div v-if="visible"
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
            <!-- Modal Header -->
            <div
                class="flex items-center justify-between p-6 bg-gray-100 border-b dark:bg-gray-700 dark:border-gray-600">
            ...
            <div class="p-6 space-y-4">
                ...
                <div class="grid grid-cols-2 gap-4 mb-6">
                    <div>
                        <p class="mb-2 text-lg font-semibold text-gray-700 dark:text-gray-300">NID Part 1</p>
                        <img v-if="customer.nid_part_1" :src="getImageUrl(customer.nid_part_1)" alt="NID Part 1"
                            class="w-full rounded-lg shadow-md" />
                    </div>
                    <div>
                        <p class="mb-2 text-lg font-semibold text-gray-700 dark:text-gray-300">NID Part 2</p>
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                        ...
                        <ProfileDetailItem v-if="customer.rejected_by" label="Rejected By" :value="customer.rejected_by" />
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                        <div>
                            <p class="mb-2 font-semibold text-gray-700 dark:text-gray-300">Address</p>
                            <p class="text-gray-600 dark:text-gray-400">
                                {{ customer.address || 'No address provided' }}
                            </p>
                        </div>
                        <div>
                            <p class="mb-2 font-semibold text-gray-700 dark:text-gray-300">Details</p>
                            <p class="text-gray-600 dark:text-gray-400">
            ...
            <!-- Modal Footer -->
            <div class="flex justify-end p-4 space-x-3 bg-gray-100 border-t dark:bg-gray-700 dark:border-gray-600">
                <button @click="printProfile"
                    class="px-4 py-2 text-white transition bg-blue-600 rounded-lg hover:bg-blue-700">
                    Print Profile
                </button>
                <button @click="$emit('close')"
                    class="px-4 py-2 text-gray-800 transition bg-gray-200 rounded-lg dark:bg-gray-600 dark:text-gray-300 hover:bg-gray-300 dark:hover:bg-gray-500">
                    Close
                </button>
            </div>
        </div>
